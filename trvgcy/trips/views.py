...
class builder(View):
    # The get method of the builder view, will just rend to the user the
    # builder.html template.
    def get(self, request):

        dict_display_flights = {'1': 'ring',
                                '2': 'fligthnum',
                                '3': 'airline',
                                '4': 'origin',
                                '5': 'destination',
        ...
        dict_display_airports = {'1': 'name',
                                 '2': 'continent',
                                 '3': 'country',
                                 '4': 'city'
                                 }

        dict_display_hotels = {'1': 'name',
                               '2': 'stars',
                               '3': 'continent',
                               '4': 'country',
                               '5': 'city',
        ...
        dict_display_event = {'1': 'name',
                              '2': 'category',
                              '3': 'ring_id',
                              '4': 'price'
                              }

        dict_display_ring = {'1': 'name',
                             '2': 'trips_in_stock',
                             '3': 'sold_trips'
                             }

        dict_display_triptemplate = {'1': 'comercial_reference',
                                     '2': 'ring',
                                     '3': 'basic_price',
                                     '4': 'stock',
                                     '5': 'sold'
...
def trip(request, trip_id):
    ...
    a = TripTemplate.objects.values_list('hoteltrip_id',
                                         flat=True).get(id=trip_id)
    # thetrip is a Django QuerySet.
    b = HotelTrip.objects.values_list('hotelid',
                                      flat=True).get(id=a)
    thehotel = Hotel.objects.get(id=b)

    a = TripTemplate.objects.values_list('eventtrip_id',
                                         flat=True).get(id=trip_id)
    b = EventTrip.objects.values_list('eventid',
                                      flat=True).get(id=a)
